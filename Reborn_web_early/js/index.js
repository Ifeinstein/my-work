(function () {
    ...
    i = this.WeakMap || this.MozWeakMap || (i = function () {
            ...
            return n.prototype.get = function (n) {
                var t, u, i, f, r;
                for (r = this.keys, t = i = 0, f = r.length; f > i; t = ++i)if (u = r[t], u === n)return this.values[t]
            }, n.prototype.set = function (n, t) {
                var i, f, r, e, u;
                for (u = this.keys, i = r = 0, e = u.length; e > r; i = ++r)if (f = u[i], f === n)return void(this.values[i] = t);
    ...
    this.WOW = function () {
        ...
        return u.prototype.defaults = {
            ...
            if (this.stopped = !1, this.boxes = function () {
                    ...
                    return r
                }.call(this), this.boxes.length)if (this.disabled())this.resetStyle(); else for (r = this.boxes, i = 0, u = r.length; u > i; i++)t = r[i], this.applyStyle(t, !0);
...
!function (n) {
    ...
    if (n.event.fixHooks)for (e = s.length; e;)n.event.fixHooks[s[--e]] = n.event.mouseHooks;
    i = n.event.special.mousewheel = {
        version: "3.1.12", setup: function () {
            if (this.addEventListener)for (var t = r.length; t;)this.addEventListener(r[--t], u, !1); else this.onmousewheel = u;
            n.data(this, "mousewheel-line-height", i.getLineHeight(this));
            n.data(this, "mousewheel-page-height", i.getPageHeight(this))
        }, teardown: function () {
            if (this.removeEventListener)for (var t = r.length; t;)this.removeEventListener(r[--t], u, !1); else this.onmousewheel = null;
    ...
    function et(ft, et) {
        ...
        function rr(n) {
            var r = n.originalEvent ? n.originalEvent : n, u = r.touches;
            if (u) {
        ...
        function gr(n) {
            var i = n.identifier !== undefined ? n.identifier : 0, t = wu(i);
        ...
        var et = n.extend({}, et), si = c || s || !et.fallbackToMouseEvents, hi = si ? s ? a ? "MSPointerDown" : "pointerdown" : "touchstart" : "mousedown", ki = si ? s ? a ? "MSPointerMove" : "pointermove" : "touchmove" : "mousemove", di = si ? s ? a ? "MSPointerUp" : "pointerup" : "touchend" : "mouseup", ri = si ? s ? "mouseleave" : null : "mouseleave", ci = s ? a ? "MSPointerCancel" : "pointercancel" : "touchcancel", at = 0, vt = null, yt = null, lt = 0, gt = 0, ni = 0, pt = 1, bt = 0, kt = 0, li = null, ot = n(ft), st = "start", ct = 0, ht = {}, gi = 0, ai = 0, vi = 0, nr = 0, ti = 0, fi = null, ei = null;
        try {
            ot.bind(hi, tr);
            ot.bind(ci, ui)
        } catch (ff) {
        ...
        this.option = function (t, i) {
            if (typeof t == "object")et = n.extend(et, t); else if (et[t] !== undefined) {
    ...
    var r = "left", u = "right", f = "up", e = "down", v = "in", y = "out", p = "none", nt = "auto", w = "swipe", b = "pinch", k = "tap", tt = "doubletap", it = "longtap", d = "horizontal", g = "vertical", l = "all", ut = 10, rt = "start", o = "move", t = "end", i = "cancel", c = "ontouchstart" in window, a = window.navigator.msPointerEnabled && !window.navigator.pointerEnabled && !c, s = (window.navigator.pointerEnabled || window.navigator.msPointerEnabled) && !c, h = "TouchSwipe";
    n.fn.swipe = function (t) {
        var r = n(this), i = r.data(h);
        if (i && typeof t == "string") {
            if (i[t])return i[t].apply(this, Array.prototype.slice.call(arguments, 1));
            n.error("Method " + t + " does not exist on jQuery.swipe")
        } else if (i && typeof t == "object")i.option.apply(this, arguments); else if (!i && (typeof t == "object" || !t))return ft.apply(this, arguments);
        return r
    };
...
$(document).ready(function () {
    $(".navbar-reborn .navbar-respond li a, a.toscroll").bind("click", function (n) {
        var t = $(this), i = t.attr("href");
        $("html,body").stop().animate({scrollTop: $(i).offset().top});
        n.preventDefault()
    });
    ...
    $('[data-spy="scroll"]').on("activate.bs.scrollspy", function () {
        $(".navbar-reborn").attr("data-nav", $(".navbar-reborn .nav li.active a").attr("href"))
    });
    ...
    var n = function (n) {
        var t = $(".navbar-reborn .navbar-respond li.active"), i = n ? t.prev() : t.next();
        i && i.find("a").click()
    };
    $(window).resize(function () {
        $(".navbar-reborn .navbar-respond li.active a").click()
    });
